...
public class TestBonds {
    ...
    private static final Bond ROSTELECOM_BOND = Bond.builder()
            ...
            .maturityDate(DateTimeTestData.createDateTime(2027, 11, 9, 3))
            .nominal(DecimalUtils.setDefaultScale(1000))
            .initialNominal(DecimalUtils.setDefaultScale(1000))
            .stateRegDate(DateTimeTestData.createDateTime(2017, 11, 16, 3))
            .placementDate(DateTimeTestData.createDateTime(2017, 11, 21, 3))
            ...
            .first1MinCandleDate(DateTimeTestData.createDateTime(2018, 3, 14, 9))
            .first1DayCandleDate(DateTimeTestData.createDateTime(2017, 11, 21, 3))
    ...
    private static final Bond KAZAKHSTAN_BOND = Bond.builder()
            ...
            .lot(1)
            .currency("rub")
            .klong(DecimalUtils.setDefaultScale(0))
            .kshort(DecimalUtils.setDefaultScale(0))
            .dlong(DecimalUtils.setDefaultScale(0))
            .dshort(DecimalUtils.setDefaultScale(0))
            .dlongMin(DecimalUtils.setDefaultScale(0))
            .dshortMin(DecimalUtils.setDefaultScale(0))
            .shortEnabledFlag(false)
            .name("ЕАБР")
            .exchange("MOEX")
            .couponQuantityPerYear(2)
            .maturityDate(DateTimeTestData.createDateTime(2025, 7, 29, 3))
            .nominal(DecimalUtils.setDefaultScale(1000))
            .initialNominal(DecimalUtils.setDefaultScale(1000))
            .stateRegDate(DateTimeTestData.createDateTime(2022, 7, 28, 3))
            .placementDate(DateTimeTestData.createDateTime(2022, 8, 2, 3))
            .placementPrice(DecimalUtils.setDefaultScale(1000))
            ...
            .blockedTcaFlag(false)
            .subordinatedFlag(false)
            .first1MinCandleDate(DateTimeTestData.createDateTime(2022, 8, 2, 14, 45))
            .first1DayCandleDate(DateTimeTestData.createDateTime(2022, 8, 2, 10))
