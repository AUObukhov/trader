...
public class TestOrderState1 {
    ...
    public static final BigDecimal EXECUTED_ORDER_PRICE = DecimalUtils.setDefaultScale(0);
    public static final BigDecimal TOTAL_ORDER_AMOUNT = DecimalUtils.setDefaultScale(30);
    public static final BigDecimal AVERAGE_POSITION_PRICE = DecimalUtils.setDefaultScale(0);
    public static final BigDecimal INITIAL_COMMISSION = DecimalUtils.setDefaultScale(0.09);
    public static final BigDecimal EXECUTED_COMMISSION = DecimalUtils.setDefaultScale(0);
    ...
    public static final BigDecimal SERVICE_COMMISSION = DecimalUtils.setDefaultScale(0);
