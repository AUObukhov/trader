...
public class TestEtf3 {
    ...
    public static final BigDecimal FIXED_COMMISSION = DecimalUtils.setDefaultScale(0.64);
    ...
    public static final BigDecimal NUM_SHARES = DecimalUtils.setDefaultScale(9600000);
