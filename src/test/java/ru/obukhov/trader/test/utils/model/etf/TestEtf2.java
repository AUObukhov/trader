...
public class TestEtf2 {
    ...
    public static final Quotation FIXED_COMMISSION = QuotationUtils.newNormalizedQuotation(0, 900000000);
    ...
    public static final Quotation NUM_SHARES = QuotationUtils.newNormalizedQuotation(330000L, 0);
