...
public class TestEtf2 {
    ...
    public static final Quotation KLONG = QuotationUtils.newQuotation(0L);
    public static final Quotation KSHORT = QuotationUtils.newQuotation(0L);
    public static final Quotation DLONG = QuotationUtils.newQuotation(0L);
    public static final Quotation DSHORT = QuotationUtils.newQuotation(0L);
    public static final Quotation DLONG_MIN = QuotationUtils.newQuotation(0L);
    public static final Quotation DSHORT_MIN = QuotationUtils.newQuotation(0L);
    ...
    public static final Quotation FIXED_COMMISSION = QuotationUtils.newQuotation(0, 900000000);
    ...
    public static final String STRING = "{\"figi\":\"BBG005HLSZ23\",\"ticker\":\"FXUS\",\"classCode\":\"TQTF\",\"isin\":\"IE00BD3QHZ91\",\"lot\":1,\"currency\":\"rub\",\"klong\":{\"units\":0,\"nano\":0},\"kshort\":{\"units\":0,\"nano\":0},\"dlong\":{\"units\":0,\"nano\":0},\"dshort\":{\"units\":0,\"nano\":0},\"dlongMin\":{\"units\":0,\"nano\":0},\"dshortMin\":{\"units\":0,\"nano\":0},\"shortEnabledFlag\":false,\"name\":\"FinEx Акции американских компаний\",\"exchange\":\"moex_close\",\"fixedCommission\":{\"units\":0,\"nano\":900000000},\"focusType\":\"equity\",\"releasedDate\":{\"seconds\":1383177600,\"nanos\":0},\"numShares\":{\"units\":330000,\"nano\":0},\"countryOfRisk\":\"US\",\"countryOfRiskName\":\"Соединенные Штаты Америки\",\"sector\":\"other\",\"rebalancingFreq\":\"quarterly\",\"tradingStatus\":\"SECURITY_TRADING_STATUS_NORMAL_TRADING\",\"otcFlag\":false,\"buyAvailableFlag\":true,\"sellAvailableFlag\":true,\"minPriceIncrement\":{\"units\":0,\"nano\":10000000},\"apiTradeAvailableFlag\":true,\"uid\":\"46a525d0-d33b-4100-a9d3-152045e5fef7\",\"realExchange\":\"REAL_EXCHANGE_MOEX\",\"positionUid\":\"37f20627-aef5-45f4-b184-e597ba3a28e5\",\"forIisFlag\":true,\"forQualInvestorFlag\":true,\"weekendFlag\":false,\"blockedTcaFlag\":false,\"first1MinCandleDate\":{\"seconds\":1520450220,\"nanos\":0},\"first1DayCandleDate\":{\"seconds\":1383177600,\"nanos\":0}}";
