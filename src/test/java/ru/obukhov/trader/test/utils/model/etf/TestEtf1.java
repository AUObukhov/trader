...
public class TestEtf1 {
    ...
    public static final Quotation NUM_SHARES = QuotationUtils.newQuotation(692000L, 0);
    ...
    public static final Quotation MIN_PRICE_INCREMENT = QuotationUtils.newQuotation(1, 0);
