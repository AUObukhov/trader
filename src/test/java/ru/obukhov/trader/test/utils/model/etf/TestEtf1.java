...
public class TestEtf1 {
    ...
    public static final Quotation NUM_SHARES = QuotationUtils.newNormalizedQuotation(692000L, 0);
    ...
    public static final Quotation MIN_PRICE_INCREMENT = QuotationUtils.newNormalizedQuotation(1, 0);
