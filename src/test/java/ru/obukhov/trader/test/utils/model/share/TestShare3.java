...
public class TestShare3 {
    ...
    public static final BigDecimal DLONG = DecimalUtils.setDefaultScale(0.25);
    public static final BigDecimal DSHORT = DecimalUtils.setDefaultScale(0.2043);
    public static final BigDecimal DLONG_MIN = DecimalUtils.setDefaultScale(0.134);
    public static final BigDecimal DSHORT_MIN = DecimalUtils.setDefaultScale(0.0974);
    ...
    public static final BigDecimal MIN_PRICE_INCREMENT = DecimalUtils.setDefaultScale(0.2);
