...
public class TestOrderState2 {
    ...
    public static final BigDecimal EXECUTED_ORDER_PRICE = DecimalUtils.setDefaultScale(30);
    public static final BigDecimal TOTAL_ORDER_AMOUNT = DecimalUtils.setDefaultScale(30);
    public static final BigDecimal AVERAGE_POSITION_PRICE = DecimalUtils.setDefaultScale(30);
    public static final BigDecimal INITIAL_COMMISSION = DecimalUtils.setDefaultScale(0.09);
    public static final BigDecimal EXECUTED_COMMISSION = DecimalUtils.setDefaultScale(0.09);
    ...
    public static final List<OrderStage> STAGES = List.of(TestOrderStages.ORDER_STAGE1.orderStage());
    public static final BigDecimal SERVICE_COMMISSION = DecimalUtils.setDefaultScale(0.1);
    ...
    public static final String JSON_STRING = "{\"orderId\":\"582899921201\"," +
            "\"executionReportStatus\":\"EXECUTION_REPORT_STATUS_FILL\"," +
            "\"lotsRequested\":1," +
            "\"lotsExecuted\":1," +
            "\"initialOrderPrice\":30.000000000," +
            "\"executedOrderPrice\":30.000000000," +
            "\"totalOrderAmount\":30.000000000," +
            "\"averagePositionPrice\":30.000000000," +
            "\"initialCommission\":0.090000000," +
            "\"executedCommission\":0.090000000," +
            "\"figi\":\"BBG00K7T3037\"," +
            "\"direction\":\"ORDER_DIRECTION_BUY\"," +
            "\"initialSecurityPrice\":30.000000000," +
            "\"stages\":[" + TestOrderStages.ORDER_STAGE1.jsonString() + "]," +
            "\"serviceCommission\":0.100000000," +
            "\"currency\":\"usd\"," +
