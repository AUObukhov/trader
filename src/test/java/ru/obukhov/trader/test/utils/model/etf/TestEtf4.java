...
public class TestEtf4 {
    ...
    public static final Exchange EXCHANGE = Exchange.MOEX_PLUS_WEEKEND;
    ...
    public static final BigDecimal MIN_PRICE_INCREMENT = DecimalUtils.setDefaultScale(0.000100000);
    public static final OffsetDateTime FIRST_1_MIN_CANDLE_DATE = DateTimeTestData.createDateTime(2020, 8, 26, 10);
    public static final OffsetDateTime FIRST_1_DAY_CANDLE_DATE = DateTimeTestData.createDateTime(2020, 8, 26, 10);

    public static ru.tinkoff.piapi.contract.v1.Etf createTinkoffEtf() {
