    ...
    static Stream<Arguments> getData_forIncludes() {
        return Stream.of(
                ...
                Arguments.of(
                        DateTimeTestData.createDateTime(2021, 10, 11, 7),
                        DateTimeTestData.createDateTime(2021, 10, 11, 19),
                        DateTimeTestData.createDateTime(2021, 10, 11, 18, 59, 59, 999_999_999),
                        true
                ),
                Arguments.of(
                        DateTimeTestData.createDateTime(2021, 10, 11, 7),
                ...
                Arguments.of(
                        DateTimeTestData.createDateTime(2021, 10, 11, 7),
                        DateTimeTestData.createDateTime(2021, 10, 11, 19),
                        DateTimeTestData.createDateTime(2021, 10, 11, 6, 59, 59, 999_999_999),
                        false
                ),
                Arguments.of(
                        DateTimeTestData.createDateTime(2021, 10, 11, 7),
                ...
                Arguments.of(
                        DateTimeTestData.createDateTime(2021, 10, 11, 7),
                        DateTimeTestData.createDateTime(2021, 10, 11, 19),
                        DateTimeTestData.createDateTime(2021, 10, 11, 19, 59, 59, 999_999_999),
                        false
                ),
                Arguments.of(
                        DateTimeTestData.createDateTime(2021, 10, 11, 7),
