...
class PointUnitTest {
    ...
    static Stream<Arguments> getData_forOf_withBigDecimal() {
        return Stream.of(
                ...
                Arguments.of(OffsetDateTime.now(), BigDecimal.valueOf(10.123123), BigDecimal.valueOf(10.12312)),
                Arguments.of(OffsetDateTime.now(), BigDecimal.valueOf(10.123125), BigDecimal.valueOf(10.12313))
        );
    }
    ...
    static Stream<Arguments> getData_forOf_withDouble() {
        return Stream.of(
                ...
                Arguments.of(OffsetDateTime.now(), 10.123123, BigDecimal.valueOf(10.12312)),
                Arguments.of(OffsetDateTime.now(), 10.123125, BigDecimal.valueOf(10.12313))
        );
    }
