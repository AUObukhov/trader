...
class LinearMovingAveragerUnitTest {
    ...
    void getAverages_withoutOrder_withoutValueExtractor_throwsIllegalArgumentException(
    ...
    @ParameterizedTest
    @MethodSource("getData_forGetAverages_withoutOrder_throwsIllegalArgumentException")
    void getAverages_withoutOrder_withValueExtractor_throwsIllegalArgumentException(
            final List<Double> values,
            final int window,
            final String expectedMessage
    ) {
    ...
    void getAverages_withOrder_withoutValueExtractor_throwsIllegalArgumentException(
            final List<Double> values,
            final int order,
            final String expectedMessage
    ) {
        ...
        AssertUtils.assertThrowsWithMessage(
                () -> averager.getAverages(bigDecimalValues, 1, order),
                IllegalArgumentException.class,
                expectedMessage
        );
    }
    ...
    void getAverages_withOrder_withValueExtractor_throwsIllegalArgumentException(
        ...
        AssertUtils.assertThrowsWithMessage(
                () -> averager.getAverages(bigDecimalValues, Optional::get, 1, order),
                IllegalArgumentException.class,
                expectedMessage
        );
    }
    ...
    void getAverages_withoutOrder_withoutValueExtractor(
            final List<Double> values,
            final int window,
    ...
    @ParameterizedTest
    @MethodSource("getData_forGetAverages_withoutOrder")
    void getAverages_withoutOrder_withValueExtractor(
            final List<Double> values,
            final int window,
            final List<Double> expectedValues
    ) {
        ...
        final List<BigDecimal> movingAverages = averager.getAverages(elements, Optional::get, window);
    ...
    void getAverages_withOrderOne_withoutValueExtractor(
        ...
        getAverages_withOrder_withoutValueExtractor(values, window, 1, expectedValues);
    }
    ...
    void getAverages_withOrderOne_withValueExtractor(
        ...
        getAverages_withOrder_withValueExtractor(values, window, 1, expectedValues);
    }
