...
class LinearMovingAveragerUnitTest {
    ...
    static Stream<Arguments> getData_forGetAverages_withoutOrder() {
        return Stream.of(
                ...
                Arguments.of(
                        ...
                        4,
                        List.of(
                                9912.000000, 9902.666667, 9889.333333, 9892.4, 9892.9,
                                9895.300000, 9892.500000, 9893.200000, 9890.8, 9889.3,
                                9886.000000, 9881.900000, 9883.200000, 9881.0, 9879.8,
                                9880.900000, 9879.500000, 9872.200000, 9867.0, 9863.4
                        )
                )
        );
    }
    ...
    static Stream<Arguments> getData_forGetAverages_withOrder() {
        return Stream.of(
                ...
                Arguments.of(List.of(1000.0, 2000.0), 4, 2, List.of(1000.0, 1444.444445)),
                ...
                Arguments.of(
                        ...
                        4,
                        2,
                        List.of(1000.0, 1888.888889, 2027.777778, 2376.666667)
                ),
                Arguments.of(
                        List.of(1000.0, 3000.0, 2000.0, 4000.0),
                        4,
                        3,
                        List.of(1000.0, 1592.592593, 1810.185185, 2036.777778)
                ),
                ...
                Arguments.of(
                        ...
                        4,
                        2,
                        List.of(1000.0, 1888.888889, 2027.777778)
                ),
                Arguments.of(
                        List.of(1000.0, 3000.0, 2000.0),
                        4,
                        3,
                        List.of(1000.0, 1592.592593, 1810.185185)
                ),
                ...
                Arguments.of(
                        ...
                        2,
                        List.of(
                                9912.000000, 9905.777778, 9897.555556, 9895.493333, 9893.013333,
                                9893.403333, 9893.410000, 9893.380000, 9892.310000, 9890.850000,
                                9888.670000, 9885.500000, 9883.980000, 9882.340000, 9881.050000,
                                9880.820000, 9880.130000, 9876.890000, 9872.450000, 9867.850000
                        )
                ),
                Arguments.of(
                        List.of(
                        ...
                        3,
                        List.of(
                                9912.000000, 9907.851852, 9902.703704, 9899.819556, 9895.942222,
                                9894.119555, 9893.537000, 9893.357000, 9892.960333, 9892.050000,
                                9890.523000, 9888.202000, 9886.061000, 9884.097000, 9882.468000,
                                9881.509000, 9880.742000, 9879.064000, 9876.155000, 9872.266000
                        )
                )
        );
    }
