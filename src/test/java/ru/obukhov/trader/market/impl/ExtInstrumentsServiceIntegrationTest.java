...
class ExtInstrumentsServiceIntegrationTest extends IntegrationTest {
    ...
    @Test
    void getEtfs_returnsEtf_whenSingleEtfExists() {
    ...
    @Test
    void getEtfs_returnsEtfIgnoreCase_whenSingleEtfExists() {
        final String figi1 = "BBG005HLTYH9";
        final String ticker1 = "fxit";
        final int lotSize1 = 1;
        final Currency currency1 = Currency.RUB;
    ...
    @Test
    void getSingleEtf_returnsEtf_whenEtfExists() {
        final String figi1 = "BBG005HLTYH9";
        final String ticker1 = "FXIT";
        final int lotSize1 = 1;
        final Currency currency1 = Currency.RUB;
    ...
    @Test
    void getSingleEtf_returnsEtfIgnoreCase_whenEtfExists() {
        final String figi1 = "BBG005HLTYH9";
        final String ticker1 = "fxit";
        final int lotSize1 = 1;
        final Currency currency1 = Currency.RUB;
    ...
    void getSingleEtf_throwIllegalArgumentException_whenMultipleEtfs() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> extInstrumentsService.getSingleShare(ticker2), expectedMessage);
    }
