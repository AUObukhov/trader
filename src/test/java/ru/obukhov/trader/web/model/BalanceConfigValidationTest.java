...
class BalanceConfigValidationTest {
    ...
    void validationSucceeds_whenEverythingIsValid() throws ParseException {
        final BalanceConfig balanceConfig = new BalanceConfig(BigDecimal.TEN, BigDecimal.ONE, new CronExpression("0 0 0 1 * ?"));
    ...
    void validationFails_whenBalanceIncrementIsZero() throws ParseException {
        final BalanceConfig balanceConfig = new BalanceConfig(BigDecimal.TEN, BigDecimal.ZERO, new CronExpression("0 0 0 1 * ?"));
    ...
    void validationFails_whenBalanceIncrementIsNullAndBalanceIncrementCronIsNotNull() throws ParseException {
        final BalanceConfig balanceConfig = new BalanceConfig(BigDecimal.TEN, null, new CronExpression("0 0 0 1 * ?"));
    ...
    void validationFails_whenBalanceIncrementIsNotNullAndBalanceIncrementCronIsNull() {
        final BalanceConfig balanceConfig = new BalanceConfig(BigDecimal.TEN, BigDecimal.ONE, null);
