...
class BalanceConfigValidationTest {
    ...
    void validationSucceeds_whenEverythingIsValid() throws ParseException {
        final BalanceConfig balanceConfig = new BalanceConfig(DecimalUtils.setDefaultScale(10), DecimalUtils.setDefaultScale(1), new CronExpression("0 0 0 1 * ?"));
    ...
    void validationFails_whenInitialBalanceIsNull() throws ParseException {
        final BalanceConfig balanceConfig = new BalanceConfig(null, DecimalUtils.setDefaultScale(1), new CronExpression("0 0 0 1 * ?"));
    ...
    void validationFails_whenBalanceIncrementIsZero() throws ParseException {
        final BalanceConfig balanceConfig = new BalanceConfig(DecimalUtils.setDefaultScale(10), DecimalUtils.setDefaultScale(0), new CronExpression("0 0 0 1 * ?"));
    ...
    void validationFails_whenBalanceIncrementIsNullAndBalanceIncrementCronIsNotNull() throws ParseException {
        final BalanceConfig balanceConfig = new BalanceConfig(DecimalUtils.setDefaultScale(10), null, new CronExpression("0 0 0 1 * ?"));
    ...
    void validationFails_whenBalanceIncrementIsNotNullAndBalanceIncrementCronIsNull() {
        final BalanceConfig balanceConfig = new BalanceConfig(DecimalUtils.setDefaultScale(10), DecimalUtils.setDefaultScale(1), null);
