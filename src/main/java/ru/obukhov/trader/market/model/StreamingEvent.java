...
public abstract class StreamingEvent {
    ...
    public static class Candle extends StreamingEvent {
        ...
        public Candle(@JsonProperty(value = "o", required = true)
                      @NotNull final BigDecimal openPrice,
    ...
    public static class Orderbook extends StreamingEvent {
        ...
        @JsonCreator
        public Orderbook(@JsonProperty(value = "depth", required = true) final int depth,
                         @JsonProperty(value = "bids", required = true)
                         @NotNull final List<BigDecimal[]> bids,
                         @NotNull
                         @JsonProperty(value = "asks", required = true) final List<BigDecimal[]> asks,
                         @JsonProperty(value = "figi", required = true)
                         @NotNull final String figi) {
            this.depth = depth;
            this.bids = bids;
